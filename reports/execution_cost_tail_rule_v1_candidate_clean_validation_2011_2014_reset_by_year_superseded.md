...
| Year | Strict rows | Eligible rows | Covered rows | Unavailable rows | Eligible coverage | Gate |
|---:|---:|---:|---:|---:|---:|---|
| 2011 | 52260 | 50940 | 49080 | 1320 | 0.963486 | fail |
| 2012 | 65450 | 61490 | 61085 | 3960 | 0.993414 | fail |
| 2013 | 28716 | 25176 | 24668 | 3540 | 0.979822 | fail |
| 2014 | 41189 | 33879 | 33555 | 7310 | 0.990437 | fail |

## Combined Result

- Combined strict-valid rows: 187615
- Combined eligible rows: 171485
- Combined covered rows: 168388
- Combined unavailable rows: 16130
- Combined eligible-row coverage: 0.981940
...
- 2012: 3960 strict-valid rows unavailable because monthly calibration had fewer than 1000 prior strict-valid rows
- 2013: 3540 strict-valid rows unavailable because monthly calibration had fewer than 1000 prior strict-valid rows
- 2014: 7310 strict-valid rows unavailable because monthly calibration had fewer than 1000 prior strict-valid rows
- combined unavailable strict-valid rows due insufficient prior history: 16130
